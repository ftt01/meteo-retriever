...
conf_file = "/home/daniele/documents/github/ftt01/phd/data/meteo/providers/dwd/etc/conf/extract/icon-eu-eps.json"
...
if process.returncode != 0:
    send_email(
        subject="ERROR: DWD icon-eu-eps NOT cropped",
    ...
    with open(conf_file) as config_file:
        ...
        send_email(
            subject="DWD icon-eu-eps data CROPPED!",
