...
conf_file = "/home/daniele/documents/github/ftt01/phd/data/meteo/providers/dwd/etc/conf/extract/icon-d2-eps_toCSV.json"
...
if process.returncode != 0:
    send_email(
        subject="ERROR: DWD NOT extracted",
