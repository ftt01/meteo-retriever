...
conf_file = "/home/daniele/documents/github/ftt01/phd/data/meteo/providers/dwd/etc/conf/extract/icon-d2.json"
...
if process.returncode != 0:
    send_email(
        subject="ERROR: DWD icon-d2 NOT cropped",
    ...
    with open(conf_file) as config_file:
        ...
        send_email(
            subject="DWD icon-d2 data CROPPED!",
